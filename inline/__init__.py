...
def inlinequery(update, context):
    ...
    inline = [
        [
            InlineKeyboardButton("My Creator", url="https://telegram.dog/imjerin"),
            InlineKeyboardButton("Other Bots", url="https://telegram.dog/mybots123")
        ]
    ]
    results = [
        InlineQueryResultDocument(
            ...
            caption="Use @UnzipTGBot for unzipping this zip file or download the file and unzip manually"
        )
    ]
